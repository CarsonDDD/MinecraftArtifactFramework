...
public class DragonRulerBanner extends ArtifactItem implements Listener{
	...
	public DragonRulerBanner() {
		this(formatName(Rarity.UNIQUE, "Dragon Banner"),Material.BLACK_BANNER,"&e&oBlessed with the power of a mighty Dragon.");
	}
	...
	public void onPlace(BlockPlaceEvent e) {
		...
		if(!e.canBuild() || e.isCancelled()) {
			e.getPlayer().sendMessage(ChatColor.translateAlternateColorCodes('&', super.FORMAT_WARN +ERROR_CANT_PLACE));
			e.setBuild(false);
			e.setCancelled(true);
			return;
		}
	...
	public void onMove(PlayerMoveEvent e) {
		...
		if(System.currentTimeMillis() >= bannerEffectTimer+(EFFECT_DURATION*1000)) {
